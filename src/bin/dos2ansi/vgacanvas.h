...
void VgaCanvas_setXY(VgaCanvas *self, char x, char y);
void VgaCanvas_up(VgaCanvas *self, char n);
void VgaCanvas_down(VgaCanvas *self, char n);
void VgaCanvas_left(VgaCanvas *self, char n);
void VgaCanvas_right(VgaCanvas *self, char n);
