...
static void help(const char *prgname)
{
    ...
    Stream_puts(out, "\n"
	    ...
	    "\t                  single quotes, with literal single quotes\n"
	    "\t                  escaped as the sequence '\\'' (shell style)\n"
	    "\t               T  title\n"
	    "\t               A  author\n"
	    "\t               G  group\n"
	    "\t               D  date (YYYYMMDD)\n"
	    "\t               C  comment -- output will be multiple lines,\n"
	    "\t                  the first one just being the number of\n"
	    "\t                  lines to follow\n"
